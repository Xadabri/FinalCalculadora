...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentesisderecho=findViewById(R.id.btnParenD);
        parentesisizquierdo=findViewById(R.id.btnParenI);
        ...
        borrar=findViewById(R.id.btnBorrartodo);
        cubo=findViewById(R.id.btnCubo);
